            ...
            Malvin.ev.on("connection.update", async (s) => {
                ...
                if (connection === "open") {
                    ...
                    const sid = megaUrl.includes("https://mega.nz/file/")
                        ? 'NIGHTMARE-MD~' + megaUrl.split("https://mega.nz/file/")[1]
                        : 'Error: Invalid URL';
...
💡 *Whats Next?* 
1️⃣ Explore all the cool features of NIGHTMARE-MD.
2️⃣ Stay updated with our latest releases and support.
3️⃣ Enjoy seamless WhatsApp automation! 🤖  

🔗 *Join Our Support Channel:* 👉 [Click Here to Join](https://whatsapp.com/channel/0029VbAiTE16xCSKuZB8Fj2L) 

⭐ *Show Some Love!* Give us a ⭐ on GitHub and support the developer of: 👉 [SAJID-XD GitHub Repo](https://github.com/SAJID-XD-1/NIGHTMARE-MD)  

🚀 _Thanks for choosing NIGHTMARE-MD — Let the automation begin!_ ✨`;
